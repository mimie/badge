...
function badgePropertiesForm(){
 ...
 $html = $html. "<div id='badgeForm' style='display:none;'>"
       ...
       . "<td align='left'><select name='logoSize'><option value='select'>Select dimension</option>"
       . "<option value='none' disabled>----</option>"
       . "<option value='width'>width</option>"
       . "<option value='height'>height</option>"
       . "<option value='default'>default size</option></select>"
       . "<input type='text' name='dimensionSize'>"
       . "</td>"
       . "</tr>"
       . "<tr>"
...
function htmlBadge($eventId,array $participant,array $properties){
   ...
   $htmlBadge = "<html>"
    ...
    $htmlBadge = $htmlBadge."<body>"
               ...
               . "<font size='".$titleSize."'><h2>".$eventName."</h2></td>"
               . "</tr>";
